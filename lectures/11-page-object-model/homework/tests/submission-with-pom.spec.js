...
await expect(confirmationPage.headerMessage).toHaveText("Thank you for your submission!")
await expect(confirmationPage.confirmFormat).toHaveText("Hands-on Workshop (90 mins)");
